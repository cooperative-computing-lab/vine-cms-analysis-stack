...
Unlike vine_reduce's own examples/quick_start and this repo's ../cortado,
this script does not spawn its own local workers with vine.Factory: it opens
a vine.Manager on --port
